const BOX_PRIO = 100;
const BOX_DEADLINE = 1; /** * @file boxTask * contains the Box type. It's a class representing the moving box on screen. * animationFn is a one shot very short REALTIME task, which moves the box. * after it is finished, it will re-instate itself into the run-queue, on * the requestAnimationFrame - interrupt */
